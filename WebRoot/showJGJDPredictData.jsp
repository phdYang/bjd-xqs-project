...
<body>
<form id="jgjd-ff" action="showPredictDataServlet" method="post">
	选择传感器：
	<input id="jgjd-cc" name="sensorId" value="">
	&nbsp;&nbsp;
	预测时间 : 未来    
