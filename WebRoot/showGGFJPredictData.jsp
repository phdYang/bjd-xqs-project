...
<body>
<form id="ggfj-ff" action="showPredictDataServlet" method="post">
	选择传感器：
	<input id="ggfj-cc" name="sensorId" value="">
	&nbsp;&nbsp;
	预测时间 : 未来    
